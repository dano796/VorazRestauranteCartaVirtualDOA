...
public class BebidaActivity extends ListActivity {
    ...
    private void setData(){
        ...
        productoActual1.ingredientesProducto = this.getResources().getString(R.string.ingredientes_bebida1);
        productoActual1.precioProducto = this.getResources().getString(R.string.precio_bebida1);
        productoActual1.imagenProducto = R.drawable.agua;
        ...
        productoActual2.ingredientesProducto = this.getResources().getString(R.string.ingredientes_bebida2);
        productoActual2.precioProducto = this.getResources().getString(R.string.precio_bebida2);
        productoActual2.imagenProducto = R.drawable.jugo_natural;
        ...
        productoActual3.ingredientesProducto = this.getResources().getString(R.string.ingredientes_bebida3);
        productoActual3.precioProducto = this.getResources().getString(R.string.precio_bebida3);
        productoActual3.imagenProducto = R.drawable.gaseosa;
