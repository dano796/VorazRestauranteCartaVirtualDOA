...
public class LicorActivity extends ListActivity {
    ...
    private void setData(){
        ...
        productoActual1.ingredientesProducto = this.getResources().getString(R.string.ingredientes_licor1);
        productoActual1.precioProducto = this.getResources().getString(R.string.precio_licor1);
        productoActual1.imagenProducto = R.drawable.whisky;
        ...
        productoActual2.ingredientesProducto = this.getResources().getString(R.string.ingredientes_licor2);
        productoActual2.precioProducto = this.getResources().getString(R.string.precio_licor2);
        productoActual2.imagenProducto = R.drawable.ron;
        ...
        productoActual3.ingredientesProducto = this.getResources().getString(R.string.ingredientes_licor3);
        productoActual3.precioProducto = this.getResources().getString(R.string.precio_licor3);
        productoActual3.imagenProducto = R.drawable.vodka;
