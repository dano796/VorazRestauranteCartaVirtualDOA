...
public class ProductoActivity extends ListActivity {
    ...
    private void setData(){
        ...
        productoActual1.ingredientesProducto = this.getResources().getString(R.string.ingredientes_entrada1);
        ...
        productoActual2.ingredientesProducto = this.getResources().getString(R.string.ingredientes_entrada2);
        ...
        productoActual3.ingredientesProducto = this.getResources().getString(R.string.ingredientes_entrada3);
