...
public class PlatoFuerteActivity extends ListActivity {
    ...
    private void setData(){
        ...
        productoActual1.ingredientesProducto = this.getResources().getString(R.string.ingredientes_plato_fuerte1);
        productoActual1.precioProducto = this.getResources().getString(R.string.precio_plato_fuerte1);
        productoActual1.imagenProducto = R.drawable.asado;
        ...
        productoActual2.ingredientesProducto = this.getResources().getString(R.string.ingredientes_plato_fuerte2);
        productoActual2.precioProducto = this.getResources().getString(R.string.precio_plato_fuerte2);
        productoActual2.imagenProducto = R.drawable.pasta;
        ...
        productoActual3.ingredientesProducto = this.getResources().getString(R.string.ingredientes_plato_fuerte3);
        productoActual3.precioProducto = this.getResources().getString(R.string.precio_plato_fuerte3);
        productoActual3.imagenProducto = R.drawable.paella;
