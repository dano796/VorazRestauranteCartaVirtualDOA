...
public class PostreActivity extends ListActivity {
    ...
    private void setData(){
        ...
        productoActual1.ingredientesProducto = this.getResources().getString(R.string.ingredientes_postre1);
        productoActual1.precioProducto = this.getResources().getString(R.string.precio_postre1);
        productoActual1.imagenProducto = R.drawable.tarta_manzana;
        ...
        productoActual2.ingredientesProducto = this.getResources().getString(R.string.ingredientes_postre2);
        productoActual2.precioProducto = this.getResources().getString(R.string.precio_postre2);
        productoActual2.imagenProducto = R.drawable.helado;
        ...
        productoActual3.ingredientesProducto = this.getResources().getString(R.string.ingredientes_postre3);
        productoActual3.precioProducto = this.getResources().getString(R.string.precio_postre3);
        productoActual3.imagenProducto = R.drawable.brownie;
